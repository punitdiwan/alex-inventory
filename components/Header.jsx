    ...
    <div style={{ zIndex: 10 }}>
            ...
            >
              ...
              >
                <img
                  ...
                  alt="logo"
                />
                <h1 className="font-semibold text-xl hover:text-[#E97208]">
                  {" "}
                  Profile
                </h1>
              </Link>
              ...
              >
                <img
                  ...
                  alt="logo"
                />
                <h1 className="pointer-events-auto font-semibold text-xl  hover:text-[#E97208]">
                  Logout
                </h1>
              </label>
              ...
              <Link
                ...
                className="flex me-3 hover:bg-slate-100 my-3"
              >
                <h1 className="font-semibold text-xl hover:text-[#E97208] mx-2">
                  Change Password
                </h1>
              </Link>
            </ul>
      ...
      <div className="modal modal-bottom sm:modal-middle">
        <div className="modal-box">
          ...
          {!isLogin && (
            <h3 className="font-bold text-[#E97208] text-lg text-center my-5">
              Logging Out Success!{" "}
            </h3>
          )}
        </div>
