    ...
    <div className=" sm:w-full h-screen pb-5 px-5 employeeButton">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div
            style={{ display: "flex" }}
            className="text-xl font-bold ms:text-4xl"
          >
      ...
      <div style={{ display: "flex", marginTop: "20px" }}>
        <div
          class="bg-white border border-blue-500 rounded-lg p-4 flex items-center space-x-4 lg:width-[600px] lg:h-[150px]
          ms:w-[690px] ms:h-[150px]
          "
        ...
        >
          ...
          <div style={{ marginLeft: "20px" }}className="ms:text-2xl md:text-sm">
            <div>IDFC Bank </div>
        ...
        <div style={{ marginLeft: "90px", marginTop: "60px" }}className="ms:hidden md:block lg:block">
          <a
            href="#add_bank"
      ...
      >
        ...
        <div className="flex">
        <div className="ml-4 lg:hidden md:hidden">
          <a
            href="#add_bank"
            className="btn border-0 hover:border hover:border-[#1366D9]
                         bg-[#1366D9] hover:bg-white hover:text-[#1366D9]"
      ...
      <div className="modal fixed inset-0 flex items-center justify-center"
        id="add_bank">
        <div className="modal-box ms:max-w-[1050px] ms:min-h-[700px] md:max-w-[1050px] md:min-h-[300px] ">
          <div
            
            className="flex  text-xl font-semibold mr-4 ms:text-4xl ms:font-bold 
            md:ml-[50px] md:mt-[5 px]
            " >
          ...
          <div className="grid  grid-cols-2 ms:grid-cols-1 lg:gap-x-5 lg:gap-y-2">
            ...
            <div className="lg:ml-[250px] ms:ml-[100px] ms:text-2xl ms:font-semibold ms:mt-[10px]" >
              <p className="mb-2 ms:hidden md:block lg:block ">Bank Name</p>
             <lable className="lg:hidden md:hidden ms:ml-[-35px] ms:mr-[95px]">Bank Name</lable>  
             <select
                className="input w-full max-w-xs border border-[#4169E1] focus:ring-[#4169E1] focus:ring-2 focus:border-[#4169E1]
            ...
            <lable className="lg:hidden md:hidden ms:ml-[-35px] ms:mr-[105px]"> Full Name </lable>
               <input
                type="text"
            ...
            <div className="lg:ml-[250px] ms:ml-[100px] ms:text-2xl ms:font-semibold ms:mt-[10px]">
            <p className="mb-2 ms:hidden md:block lg:block ">Account No.</p>
            <lable className="lg:hidden md:hidden ms:ml-[-35px] ms:mr-[90px]">Account No.</lable>
              <input
                type="text"
            ...
            <div className="lg:ml-[50px] ms:ml-[100px] ms:text-2xl ms:font-semibold ms:mt-[10px]" >
            <p className="mb-2 ms:hidden md:block lg:block ">Confirm Account No.</p>
            <lable className="lg:hidden md:hidden  ms:ml-[-35px]">Confirm Account No.</lable>
              <input
                type="text"
                placeholder="12345678901"
                className="input w-full max-w-xs border border-[#4169E1] focus:ring-[#4169E1] focus:ring-2 focus:border-[#4169E1]
            ...
            <div className="lg:ml-[250px] ms:ml-[100px] ms:text-2xl ms:font-semibold ms:mt-[10px]" >
            <p className="mb-2 ms:hidden md:block lg:block ">IFSC Code</p>
            <lable className="lg:hidden md:hidden ms:ml-[-35px] ms:mr-[115px] ">IFSC Code</lable>
              <input
                type="text"
            ...
            <div className="lg:ml-[50px] ms:ml-[100px] ms:text-2xl ms:font-semibold ms:mt-[10px]" >
            <p className="mb-2 ms:hidden md:block lg:block ">Type of Account</p>
            <lable className="lg:hidden md:hidden ms:ml-[-35px] ms:mr-[55px]">Type of Account</lable>
              <select
                className="input w-full max-w-xs border border-[#4169E1] focus:ring-[#4169E1] focus:ring-2 focus:border-[#4169E1]
                ms:w-[400px] ms:h-[70px] md:w-[300px] md:h-[50px]
                "
          ...
          <div style={{ marginTop: "20px" }}>
            <div style={{ display: "flex" }}>
              <div
                ...
                style={{ marginTop: "10px", marginLeft: "47px" }}
              >
                Transaction ID
              </div>
            ...
            <div style={{ display: "flex" }}>
              ...
              <div style={{ marginTop: "10px", marginLeft: "146px" }}>
                Himalaya
              </div>
            </div>
            ...
            <div style={{ display: "flex" }}>
              ...
              <div style={{ marginTop: "10px", marginLeft: "177px" }}>
                Supplier1
              </div>
            </div>
            ...
            <div style={{ display: "flex" }}>
              ...
              <div style={{ marginTop: "10px", marginLeft: "175px" }}>
                43 Packets
              </div>
            </div>
            ...
            <div style={{ display: "flex" }}>
              ...
              <div style={{ marginTop: "10px", marginLeft: "145px" }}>
                ₹ 240
              </div>
            </div>
            ...
            <div style={{ display: "flex" }}>
              ...
              <div style={{ marginTop: "10px", marginLeft: "157px" }}>
                ₹ 6,200
              </div>
            </div>
            <div style={{ display: "flex" }}>
            ...
            <div style={{ display: "flex" }}>
              ...
              <div style={{ marginTop: "10px", marginLeft: "121px" }}>
                Online/Net Banking
              </div>
            </div>
            ...
            <div style={{ display: "flex" }}>
              ...
              <div style={{ marginTop: "10px", marginLeft: "131px" }}>
                20/06/23
              </div>
            </div>
            <div style={{ display: "flex" }}>
              ...
              <div style={{ marginTop: "10px", marginLeft: "105px" }}>
                ₹ 0,000
              </div>
            </div>
          </div>
