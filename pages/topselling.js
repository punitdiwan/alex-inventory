  ...
  return (
    ...
    {/**end the for Inventroy category */}
      ...
      <div className="bg-white ms:mt-[20px] md:mt-[10px]">
        <div className="flex justify-between items-center">
          <h2 style={{ color: "black", fontWeight: "bold" }} className="ml-3 ms:text-4xl 
          md:text-xl
          lg:text-xl">
            Top Selling
          </h2>
       ...
       <section className="border-2 ms:mt-[10px] md:border-none ms:max-h-[790px] ms:max-w-[700px] md:max-h-[550px] md:max-w-[1200px] ms:overflow-y-auto md:overflow-y-auto lg:scrollbar-hide">
        <table className="table  w-full  employeeTable ">
          <thead>
            <tr>
              {/* <th>S.No.</th> */}
              <th className="ms:font-extrabold text-2xl md:text-sm lg:text-sm">Category Name</th>
          ...
          <tbody>
            {currentItems.map((item, index) => (
              <tr key={item.id}>
                ...
                <td className="cursor-pointer ms:text-xl ms:font-bold md:text-sm md:font-normal ">
                  <div style={{ display: "flex" }}>{item.total_Brands}</div>
                </td>
                <td className="ms:text-xl ms:font-bold md:text-sm md:font-normal">{item.total_product}</td>
                <td className="ms:text-xl ms:font-bold md:text-sm md:font-normal"><img src={item.image}/></td>
                <td className="ms:text-xl ms:font-bold md:text-sm md:font-normal">{item.description}</td>
                <td className="flex">
                  <a href="#emp_Profile">
                    <img
...
export default Layout(topselling);
